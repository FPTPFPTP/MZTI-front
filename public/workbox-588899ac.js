define(['exports'], function (t) {
        ...
        findMatchingRoute({ url: t, sameOrigin: e, request: s, event: n }) {
            ...
            for (const i of r) {
                ...
                if (a)
                    return (
                        (r = a),
                        ((Array.isArray(r) && 0 === r.length) || (a.constructor === Object && 0 === Object.keys(a).length) || 'boolean' == typeof a) &&
                            (r = void 0),
                        { route: i, params: r }
                    );
            }
    ...
    class m {
        ...
        async getCacheKey(t, e) {
            ...
            if (!this.h[s]) {
                let n = t;
                for (const t of this.iterateCallbacks('cacheKeyWillBeUsed')) n = g(await t({ mode: e, request: n, event: this.event, params: this.params }));
                this.h[s] = n;
            }
            return this.h[s];
        }
    ...
    class R {
        ...
        async v(t, e, n) {
            ...
            try {
                if (((r = await this.D(e, t)), !r || 'error' === r.type)) throw new s('no-response', { url: e.url });
            } catch (s) {
                if (s instanceof Error)
                    for (const i of t.iterateCallbacks('handlerDidError')) if (((r = await i({ error: s, event: n, request: e })), r)) break;
                if (!r) throw s;
            }
    ...
    function T(t) {
        return 'function' == typeof t
            ...
            : (t instanceof IDBTransaction &&
              ...
              q(t, D || (D = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])) ? new Proxy(t, E) : t);
    }
    function k(t) {
    ...
    E = ((t) => b({}, t, { get: (e, s, n) => j(e, s) || t.get(e, s, n), has: (e, s) => !!j(e, s) || t.has(e, s) }))(E);
    try {
    ...
    class A {
        ...
        async setTimestamp(t, e) {
            const s = { url: (t = K(t)), timestamp: e, cacheName: this._, id: this.I(t) },
        ...
        async expireEntries(t, e) {
            ...
            for (; n; ) {
                const s = n.value;
                s.cacheName === this._ && ((t && s.timestamp < t) || (e && i >= e) ? r.push(n.value) : i++), (n = await n.continue());
            }
            const a = [];
        ...
        async getDb() {
            return (
                this.U ||
                    (this.U = await (function (t, e, { blocked: s, upgrade: n, blocking: r, terminated: i } = {}) {
    ...
    class F {
        constructor(t, e = {}) {
            (this.C = !1), (this.O = !1), (this.T = e.maxEntries), (this.k = e.maxAgeSeconds), (this.B = e.matchOptions), (this._ = t), (this.P = new A(t));
        }
        async expireEntries() {
    ...
    class J {
        constructor({ precacheController: t }) {
            (this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
                const s = (null == e ? void 0 : e.cacheKey) || this.M.getCacheKeyForURL(t.url);
    ...
    class Z extends R {
        ...
        K() {
            ...
            for (const [s, n] of this.plugins.entries())
                n !== Z.copyRedirectedCacheableResponsesPlugin && (n === Z.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
            0 === e ? this.plugins.push(Z.defaultPrecacheCacheabilityPlugin) : e > 1 && null !== t && this.plugins.splice(t, 1);
        }
    }
    (Z.defaultPrecacheCacheabilityPlugin = { cacheWillUpdate: async ({ response: t }) => (!t || t.status >= 400 ? null : t) }),
        (Z.copyRedirectedCacheableResponsesPlugin = { cacheWillUpdate: async ({ response: t }) => (t.redirected ? await Y(t) : t) });
    class tt {
        constructor({ cacheName: t, plugins: e = [], fallbackToNetwork: s = !0 } = {}) {
            (this.A = new Map()),
                (this.F = new Map()),
                (this.H = new Map()),
                (this.u = new Z({ cacheName: w.getPrecacheName(t), plugins: [...e, new J({ precacheController: this })], fallbackToNetwork: s })),
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                if (this.A.has(r) && this.A.get(r) !== t) throw new s('add-to-cache-list-conflicting-entries', { firstEntry: this.A.get(r), secondEntry: t });
                if ('string' != typeof n && n.integrity) {
                    if (this.H.has(t) && this.H.get(t) !== n.integrity) throw new s('add-to-cache-list-conflicting-integrities', { url: r });
    ...
    (t.CacheFirst = class extends R {
        ...
        (t.NetworkFirst = class extends R {
            constructor(t = {}) {
                super(t), this.plugins.some((t) => 'cacheWillUpdate' in t) || this.plugins.unshift(u), (this.Z = t.networkTimeoutSeconds || 0);
            }
            async D(t, e) {
                const n = [],
                    r = [];

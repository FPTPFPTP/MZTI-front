...
const ItemContent = ({ id, title, categoryId, content, pollList, tags }: IItemContentProps) => {
            ...
            {categoryId === 23 ? (
                ...
                <>
                    ...
                    {pollList.length ? (
                        ...
                        thumbnail && <Image className={'thumbnail'} src={thumbnail} alt={'게시글 이미지'} layout={'responsive'} width={280} height={150} />
                    )}
                </>
            )}
        </section>
